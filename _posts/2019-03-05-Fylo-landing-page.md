...
[프로젝트 완성 파일](https://github.com/lemidia/fylo-landing-page)

저장소를 클론하여, 압축을 푼 다음, index.html 파일을 실행시켜 주세요.

밑은 프로젝트의 README.md 입니다.

![Design preview for the Huddle landing page with alternating feature blocks coding challenge](/assets/images/desktop-preview-fylo-landing-page.jpg)
