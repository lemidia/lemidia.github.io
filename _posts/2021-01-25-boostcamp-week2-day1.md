...
![Alt text](/assets/images/vector-4.png){: width="300px" .align-center}
...
회의를 통해 의견이 모아졌고, 기존에 하던 "어제 무엇을 하였고, 오늘의 공부 계획은?" 계속 진행하고, 이제 edwith에 오늘 다룬 토픽에 대해 좀 더 알아보기란 목록으로 "further question"이 추가 된다고 하여 이와 묶어 당일 다뤄진 내용 중 다소 어렵거나 이해가 안간 내용과 같이 피어들과 공부하기로 했습니다.
